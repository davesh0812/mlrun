...
Revision ID: 33c054033e8a
Revises: dd6049a25a81
Create Date: 2024-11-03 18:19:08.314055
...
def upgrade():
    ...
    op.create_index(
        "idx_artifacts_v2_key_uid_project",
        "artifacts_v2",
        ["key", "uid", "project"],
    )
    op.create_table(
...
def downgrade():
    ...
    op.drop_index("idx_artifacts_v2_key_uid_project", table_name="artifacts_v2")
