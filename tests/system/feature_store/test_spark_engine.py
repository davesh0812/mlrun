...
class TestFeatureStoreSparkEngine(TestMLRunSystem):
    ...
    test_branch = "https://github.com/davesh0812/mlrun.git@join_spark_test"  # For testing specific branch. e.g.: "https://github.com/mlrun/mlrun.git@development"
    ...
    def test_get_offline_features_with_spark_engine(self):
        ...
        assert resp_df.equals(target_df)
        assert resp_df.equals(expected_df)
    ...
    def test_relation_join(self, join_type, engine='spark',with_indexes=False):
