...
class HuggingFaceModelHandler(DLModelHandler):
    """
    Class for handling a HuggingFace model, enabling loading and saving it during runs.
    """

    # Framework name:
    FRAMEWORK_NAME = "hugging_face"
